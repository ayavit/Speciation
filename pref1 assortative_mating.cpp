...
int main(int argc, char* argv[])
{
	...
	int NGEN = 20000;   // number of generations to run
	...
	//				mut_list[i].list = (unsigned int *) realloc (mut_list[i].list, (mut_list[i].nmax+20)*sizeof (unsigned int)) ;
		...
		if (gen % 10 == 9){
            ...
            if (gen % 1000 == 9){
	            ...
	            sprintf(fffname, "with_selection_assortative_mating_NCH%dCONT_PROB%fNGEN%dMUT_PROB%ftheta%fseed_for_rand%dgen%d_number_of_failures.txt",NCH, CONT_PROB, NGEN, MUT_PROB, theta, seed_for_rand, gen); 
	            fff = fopen(fffname, "w");
                ...
                sprintf(ffname, "with_selection_assortative_mating_NCH%dCONT_PROB%fNGEN%dMUT_PROB%ftheta%fseed_for_rand%dgen%d_number_of_successes.txt",NCH, CONT_PROB, NGEN, MUT_PROB, theta, seed_for_rand, gen); 
	            ff = fopen(ffname, "w");
		...
		if (gen % 1000 == 999){ 
			...
			sprintf(fname, "with_selection_assortative_mating_NCH%dCONT_PROB%fNGEN%dMUT_PROB%ftheta%fseed_for_rand%dgen%d_just_0_1.txt",NCH, CONT_PROB, NGEN, MUT_PROB, theta, seed_for_rand, gen); 
			f = fopen(fname, "w");
			for (t=0; t<7; t++){
				for (r=0; r<NCH; r++){
			...
			sprintf(fname, "with_selection_assortative_mating_NCH%dCONT_PROB%fNGEN%dMUT_PROB%ftheta%fseed_for_rand%dgen%d_causative.txt",NCH, CONT_PROB, NGEN, MUT_PROB, theta, seed_for_rand, gen); 
			f = fopen(fname, "w");
			for (t=0; t<7; t++){
				for (r=0; r<NCH; r++){
					int loc1 = (r + try_dists[t]) % NCH;
			...
			//sprintf(fname, "with_selection_assortative_mating_NCH%dCONT_PROB%fNGEN%dMUT_PROB%ftheta%fseed_for_rand%dgen%d_times.txt",NCH, CONT_PROB, NGEN, MUT_PROB, theta, seed_for_rand, gen); 
			//f = fopen(fname, "w");
			...
			// name of the file
			sprintf(fname_all_mutations, "with_selection_assortative_mating_NCH%dCONT_PROB%fNGEN%dMUT_PROB%ftheta%fseed_for_rand%dgen%d_all_mutations.txt",NCH, CONT_PROB, NGEN, MUT_PROB, theta, seed_for_rand, gen); 
			...
			// name of the file
			sprintf(fname_all_mutations, "with_selection_assortative_mating_NCH%dCONT_PROB%fNGEN%dMUT_PROB%ftheta%fseed_for_rand%dgen%d_two_copies.txt",NCH, CONT_PROB, NGEN, MUT_PROB, theta, seed_for_rand, gen); 
